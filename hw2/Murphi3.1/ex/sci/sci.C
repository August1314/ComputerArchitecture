/******************************
  Program "sci.m" compiled by "Murphi Release 3.1"
...
class mu_1_NodeId: public mu__byte
{
 public:
  ...
  int indexvalue()
  {
    ...
    if ((value() >= 4) && (value() <= 4)) return (value() - 1);
  };
  inline int unionassign(int val)
  {
    if (val >= 0 && val <= 2) return value(val+1);
    if (val >= 3 && val <= 3) return value(val+1);
  };
...
class mu_1_AccessTypes: public mu__long
{
 public:
  ...
  mu_1_AccessTypes (char *name, int os): mu__long(241, 256, 5, name, os) {};
  mu_1_AccessTypes (void): mu__long(241, 256, 5) {};
  mu_1_AccessTypes (int val): mu__long(241, 256, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
void mu_1_ReqPacket::set_self(char *n, int os)
{
  ...
  mu_cmd.set_self_2(name, ".cmd", os + 8 );
  mu_sourceId.set_self_2(name, ".sourceId", os + 16 );
  mu_offset.set_self_2(name, ".offset", os + 24 );
  mu_mopCop.set_self_2(name, ".mopCop", os + 32 );
  mu_s.set_self_2(name, ".s", os + 40 );
  mu_eh.set_self_2(name, ".eh", os + 48 );
  mu_data.set_self_2(name, ".data", os + 56 );
  mu_newId.set_self_2(name, ".newId", os + 64 );
  mu_memId.set_self_2(name, ".memId", os + 72 );
}
...
void mu_1_ResPacket::set_self(char *n, int os)
{
  ...
  mu_cn.set_self_2(name, ".cn", os + 8 );
  mu_co.set_self_2(name, ".co", os + 16 );
  mu_mCState.set_self_2(name, ".mCState", os + 24 );
  mu_data.set_self_2(name, ".data", os + 32 );
  mu_forwId.set_self_2(name, ".forwId", os + 40 );
  mu_backId.set_self_2(name, ".backId", os + 48 );
}
...
void mu_1__type_0::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"MemoryLineId_1", i * 24 + os);i++;
}
...
void mu_1_CacheLine::set_self(char *n, int os)
{
  ...
  mu_cState.set_self_2(name, ".cState", os + 0 );
  mu_forwId.set_self_2(name, ".forwId", os + 8 );
  mu_backId.set_self_2(name, ".backId", os + 16 );
  mu_memId.set_self_2(name, ".memId", os + 24 );
  mu_addrOffset.set_self_2(name, ".addrOffset", os + 32 );
  mu_data.set_self_2(name, ".data", os + 40 );
}
...
void mu_1__type_1::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"CacheLineId_1", i * 48 + os);i++;
}
...
void mu_1_LB::set_self(char *n, int os)
{
  ...
  mu_firstEntrySub.set_self_2(name, ".firstEntrySub", os + 16 );
  mu_memId.set_self_2(name, ".memId", os + 24 );
  mu_addrOffset.set_self_2(name, ".addrOffset", os + 32 );
}
...
void mu_1_SubState::set_self(char *n, int os)
{
  ...
  mu_lC.set_self_2(name, ".lC", os + 40 );
}
...
void mu_1_L0::set_self(char *n, int os)
{
  ...
  mu_mState.set_self_2(name, ".mState", os + 8 );
  mu_co.set_self_2(name, ".co", os + 16 );
}
...
void mu_1_L1::set_self(char *n, int os)
{
  ...
  mu_firstLoop.set_self_2(name, ".firstLoop", os + 8 );
  mu_cState.set_self_2(name, ".cState", os + 16 );
}
...
void mu_1_L2::set_self(char *n, int os)
{
  ...
  mu_firstLoop.set_self_2(name, ".firstLoop", os + 8 );
  mu_cState.set_self_2(name, ".cState", os + 16 );
  mu_nextId.set_self_2(name, ".nextId", os + 24 );
}
...
void mu_1_ToState::set_self(char *n, int os)
{
  ...
  mu_l1.set_self_2(name, ".l1", os + 24 );
  mu_l2.set_self_2(name, ".l2", os + 48 );
}
...
void mu_1_ExecState::set_self(char *n, int os)
{
  ...
  mu_insPhase.set_self_2(name, ".insPhase", os + 32 );
  mu_cTPtr.set_self_2(name, ".cTPtr", os + 64 );
  mu_tStat.set_self_2(name, ".tStat", os + 72 );
  mu_fetchOption.set_self_2(name, ".fetchOption", os + 104 );
  mu_data.set_self_2(name, ".data", os + 136 );
  mu_subState.set_self_2(name, ".subState", os + 144 );
  mu_toState.set_self_2(name, ".toState", os + 192 );
}
...
void mu_1_ExecUnit::set_self(char *n, int os)
{
  ...
  mu_reqPacket.set_self_2(name, ".reqPacket", os + 272 );
  mu_resPacket.set_self_2(name, ".resPacket", os + 352 );
}
...
void mu_1_Proc::set_self(char *n, int os)
{
  ...
  mu_cache.set_self_2(name, ".cache", os + 408 );
}
...
void mu_1__type_2::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"ProcId_1", i * 456 + os);i++;
array[i].set_self_ar(n,"ProcId_2", i * 456 + os);i++;
array[i].set_self_ar(n,"ProcId_3", i * 456 + os);i++;
}
...
void mu_1__type_3::set_self( char *n, int os)
  {
    int i=0;
    name = n;
array[i].set_self_ar(n,"MemoryId_1", i * 24 + os);i++;
}
...
/*** Variable declaration ***/
mu_1__type_3 mu_memory("memory",1400);
